 ...
 */ async function connect(opts, proxy, proxyOpts) {
    ...
    try {
        ...
        const connOpts = {
            ...
            setHost: false,
            headers: {
                ...(proxyOpts == null ? void 0 : proxyOpts.headers) || {},
        ...
        if (proxy.username || proxy.password) {
            const base64 = Buffer.from(`${decodeURIComponent(proxy.username || '')}:${decodeURIComponent(proxy.password || '')}`).toString('base64');
